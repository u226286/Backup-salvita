        ...
        <?php
        	...
        	if(isset($_POST['rimuovere'])===true){
                ...
                if($result->num_rows === 1){
                    ...
                    $result = $conn->query($query);
                    if(!$result === false) {
                        echo '<span class="filtra">Tecnico rimosso con successo</span>';
                    } else {
                    	echo '<span class="filtra">Tecnico non rimosso, si è verifica un problema</span>';
                    }
                } else {
                	echo '<span class="filtra">Tecnico non rimosso, nessun tecnico ha ID: '.$id.'</span>';
                }
            }
        ?>
	...
	<form class="form"  action="operazioniTecnici.php" method="post">
        ...
        <?php
            ...
            if(isset($_POST['recuperare'])===true){
                ...
                $result = $conn->query($query);
                if($result->num_rows === 1){
                	echo '<span class="filtra">Recuperati i dati del tecnico con ID: '.$id.'</span>';
                } else {
                	echo '<span class="filtra">Non è presente nessun tecnico con ID: '.$id.'</span>';
                }
            }
        ?>
        <br /><br />
